...
//        inherit React.Props<ScrollViewStatic>
    ...
    type [<Import("*","react-native")>] Globals =
        static member ActivityIndicator with get(): ActivityIndicatorStatic = failwith "JS only" and set(v: ActivityIndicatorStatic): unit = failwith "JS only"
        ...
        static member ListView with get(): ListViewStatic<obj> = failwith "JS only" and set(v: ListViewStatic<obj>): unit = failwith "JS only"
        ...
        static member PickerItem with get(): PickerItemStatic = failwith "JS only" and set(v: PickerItemStatic): unit = failwith "JS only"
        static member PickerIOS with get(): PickerIOSStatic = failwith "JS only" and set(v: PickerIOSStatic): unit = failwith "JS only"
        static member PickerIOSItem with get(): PickerIOSItemStatic = failwith "JS only" and set(v: PickerIOSItemStatic): unit = failwith "JS only"
        ...
        static member SwipeableListView with get(): SwipeableListViewStatic<obj> = failwith "JS only" and set(v: SwipeableListViewStatic<obj>): unit = failwith "JS only"
        ...
        static member TabBarItem with get(): TabBarItemStatic = failwith "JS only" and set(v: TabBarItemStatic): unit = failwith "JS only"
        ...
        static member KeyboardAvoidingView with get(): KeyboardAvoidingViewStatic = failwith "JS only" and set(v: KeyboardAvoidingViewStatic): unit = failwith "JS only"
        ...
        static member NavigationAnimatedView with get(): NavigationAnimatedViewStatic = failwith "JS only" and set(v: NavigationAnimatedViewStatic): unit = failwith "JS only"
        static member NavigationHeader with get(): NavigationHeaderStatic = failwith "JS only" and set(v: NavigationHeaderStatic): unit = failwith "JS only"
        static member NavigationCardStack with get(): NavigationCardStackStatic = failwith "JS only" and set(v: NavigationCardStackStatic): unit = failwith "JS only"
        static member Easing with get(): EasingStatic = failwith "JS only" and set(v: EasingStatic): unit = failwith "JS only"
        static member NativeModules with get(): obj = failwith "JS only" and set(v: obj): unit = failwith "JS only"
        static member NativeAppEventEmitter with get(): NativeAppEventEmitterStatic = failwith "JS only" and set(v: NativeAppEventEmitterStatic): unit = failwith "JS only"
        ...
        static member requireNativeComponent(viewName: string, ?componentInterface: ComponentInterface<'P>, ?extraConfig: obj): React.ComponentClass<'P> = failwith "JS only"
