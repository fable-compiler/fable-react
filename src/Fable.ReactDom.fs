...
type IReactDomClient =
    ...
    /// Requires React 18.
    abstract createRoot: container: Element * ?options: IRootOptions -> IReactRoot
    ...
    /// Requires React 18.
    abstract hydrateRoot: container: Element * element: ReactElement * ?options: IRootOptions -> unit
